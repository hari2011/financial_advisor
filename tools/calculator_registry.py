...
CALCULATORS = {
    ...
    "ctc": {
        ...
        "icon": "💼",
        "description": "Break down annual CTC into monthly take-home salary",
        "fields": [
        ...
        "fn": lambda d: ctc_to_take_home(d["ctc_annual"], d.get("basic_pct", 50) / 100),
        "result_format": [
            {"key": "take_home_monthly_new", "label": "Monthly Take-Home (New Regime)", "fmt": "currency"},
            {"key": "take_home_monthly_old", "label": "Monthly Take-Home (Old Regime)", "fmt": "currency"},
            {"key": "take_home_annual_new", "label": "Annual Take-Home (New)", "fmt": "currency"},
            {"key": "tax_new_regime", "label": "Tax (New Regime)", "fmt": "currency"},
            {"key": "tax_old_regime", "label": "Tax (Old Regime)", "fmt": "currency"},
            {"key": "effective_tax_rate_new", "label": "Effective Tax Rate (New)", "fmt": "pct"},
            {"key": "effective_tax_rate_old", "label": "Effective Tax Rate (Old)", "fmt": "pct"},
            {"key": "basic_monthly", "label": "Monthly Basic", "fmt": "currency"},
            {"key": "hra_monthly", "label": "Monthly HRA", "fmt": "currency"},
            {"key": "special_allowance_monthly", "label": "Monthly Special Allowance", "fmt": "currency"},
            {"key": "epf_employee_monthly", "label": "EPF (Monthly)", "fmt": "currency"},
            {"key": "gross_monthly", "label": "Monthly Gross", "fmt": "currency"},
            {"key": "total_retirement_monthly", "label": "Retirement Accrual/Month", "fmt": "currency"},
        ],
    },
    ...
    "fire": {
        ...
        "result_format": [
            ...
            {"key": "lean_fire_corpus", "label": "🟢 Lean FIRE (frugal, ×25 of 60%)", "fmt": "currency"},
            {"key": "years_to_lean_fire", "label": "   ↳ Years to Lean FIRE", "fmt": "number"},
            {"key": "regular_fire_corpus", "label": "🔵 Regular FIRE (4% rule, ×25)", "fmt": "currency"},
            {"key": "years_to_regular_fire", "label": "   ↳ Years to Regular FIRE", "fmt": "number"},
            {"key": "barista_fire_corpus", "label": "☕ Barista FIRE (70% covered, ×33)", "fmt": "currency"},
            {"key": "years_to_barista_fire", "label": "   ↳ Years to Barista FIRE", "fmt": "number"},
            {"key": "fat_fire_corpus", "label": "💎 Fat FIRE (luxury, ×50)", "fmt": "currency"},
            {"key": "years_to_fat_fire", "label": "   ↳ Years to Fat FIRE", "fmt": "number"},
            {"key": "coast_fire_corpus", "label": "🏖️ Coast FIRE (invest once, let it grow)", "fmt": "currency"},
